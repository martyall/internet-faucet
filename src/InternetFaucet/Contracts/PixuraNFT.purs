...
module InternetFaucet.Contracts.PixuraNFT where
...
newtype RemoveFromWhitelist = RemoveFromWhitelist {_newAddress :: Address}
...
instance indexedEventRemoveFromWhitelist :: IndexedEvent (Tuple1 (Tagged (SProxy "_newAddress") Address)) (Tuple0 ) RemoveFromWhitelist where
  isAnonymous _ = false
